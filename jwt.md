# JSON Web Tokens (JWT) in OneChain
...
![Encoded JWT](/static/jwt/encoded-jwt3.png)
...
![JWT.IO Debugger](/static/jwt/legacy-app-auth-5.png)
...
![How a JSON Web Token works](/static/jwt/jwt-diagram.png)
